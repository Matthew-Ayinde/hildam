  ...
  return (
    ...
    <div className="w-full mx-auto p-6 bg-white rounded-2xl shadow-md">
      <div className="flex items-center justify-between mb-6">
        <Link href="/project-manager/joblists/projects" className="hover:text-orange-700 text-orange-500 flex flex-row items-center">
      ...
      <div className="mt-6 flex justify-end space-x-4">
        <Link href={`/project-manager/joblists/projects/${id}/edit`} className="px-4 py-2 bg-orange-500 text-white rounded">
          Edit
        </Link>
      </div>
    </div>
