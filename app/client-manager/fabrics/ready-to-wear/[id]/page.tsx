...
import ProductFormModal from "@/components/client-manager/ready-to-wear/ProductFormModal"
import DeleteProductModal from "@/components/client-manager/ready-to-wear/DeleteProductModal"
import ProductDetailsSkeleton from "@/components/client-manager/ready-to-wear/ProductDetailsSkeleton"
...
export default function ReadyToWearDetailPage() {
  ...
  const onDelete = async () => {
    ...
    try {
      ...
      window.location.href = "/client-manager/fabrics/ready-to-wear"
    } catch (deleteError) {
      toast({
  ...
  if (error || !product) {
    return (
      <div className="space-y-4">
        <Link href="/client-manager/fabrics/ready-to-wear" className="inline-flex items-center gap-2 text-sm text-orange-600">
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <Link href="/client-manager/fabrics/ready-to-wear" className="inline-flex items-center gap-2 text-sm font-medium text-orange-600">
          <IoArrowBack size={16} /> Back to list
        </Link>
