          ...
          <div className="space-y-6">
            ...
            >
              <Card className="border-0 shadow-lg">
                ...
                <CardContent>
                  <div className="space-y-3">
                    <Link href="/client-manager/users" className="block p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                      <span className="text-sm font-medium text-gray-900">View All Users</span>
                    </Link>
                    <Link href="/client-manager/users/create" className="block p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
