  ...
  const quickSteps = [
    {
      ...
      time: "2 min",
      link: "/client-manager/help/dashboard"
    },
    {
      step: 2,
      ...
      time: "5 min",
      link: "/client-manager/help/customers"
    },
    {
      step: 3,
      ...
      time: "8 min",
      link: "/client-manager/help/orders"
    },
    {
      step: 4,
      ...
      time: "6 min",
      link: "/client-manager/help/inventory"
    }
  ]
              ...
              <Card className="border-0 shadow-lg bg-gradient-to-br from-orange-50 to-orange-100">
                <CardContent className="p-6">
                  <div className="text-center">
                    ...
                    <Link href="/client-manager/help/navigation">
                      <motion.button
                        whileHover={{ scale: 1.02 }}
                        whileTap={{ scale: 0.98 }}
