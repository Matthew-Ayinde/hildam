          ...
          <div className="space-y-6">
            ...
            >
              <Card className="border-0 shadow-lg">
                ...
                <CardContent>
                  <div className="space-y-3">
                    <Link href="/client-manager/inventory" className="block p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                      <span className="text-sm font-medium text-gray-900">View All Items</span>
                    </Link>
                    <Link href="/client-manager/inventory/create" className="block p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                      <span className="text-sm font-medium text-gray-900">Add New Item</span>
                    </Link>
                    <Link href="/client-manager/inventory/requests" className="block p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
