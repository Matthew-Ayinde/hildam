...
import HelpNavigation from "@/components/client-manager/help/HelpNavigation"
          ...
          <div className="space-y-6">
            ...
            >
              <Card className="border-0 shadow-lg">
                ...
                <CardContent>
                  <div className="space-y-3">
                    <Link href="/client-manager/help/analytics" className="block p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                      <div className="flex items-center gap-3">
                        <BarChart3 className="w-4 h-4 text-gray-600" />
                        <span className="text-sm font-medium text-gray-900">Analytics Deep Dive</span>
                      </div>
                    </Link>
                    <Link href="/client-manager/help/notifications" className="block p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                      <div className="flex items-center gap-3">
                        <Package className="w-4 h-4 text-gray-600" />
                        <span className="text-sm font-medium text-gray-900">Notification Settings</span>
                      </div>
                    </Link>
                    <Link href="/client-manager/help/customization" className="block p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                      <div className="flex items-center gap-3">
