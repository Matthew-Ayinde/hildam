          ...
          <div className="space-y-6">
            ...
            >
              <Card className="border-0 shadow-lg">
                ...
                <CardContent>
                  <div className="space-y-3">
                    <Link href="/client-manager/customers/create" className="block p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                      <div className="flex items-center gap-3">
                        <UserPlus className="w-4 h-4 text-gray-600" />
                        <span className="text-sm font-medium text-gray-900">Add New Customer</span>
                      </div>
                    </Link>
                    <Link href="/client-manager/customers" className="block p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                      <div className="flex items-center gap-3">
                        <Users className="w-4 h-4 text-gray-600" />
                        <span className="text-sm font-medium text-gray-900">View All Customers</span>
                      </div>
                    </Link>
                    <Link href="/client-manager/help/orders" className="block p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                      <div className="flex items-center gap-3">
