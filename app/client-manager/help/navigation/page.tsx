          ...
          <div className="space-y-6">
            ...
            >
              <Card className="border-0 shadow-lg">
                ...
                <CardContent>
                  <div className="space-y-3">
                    <Link href="/client-manager" className="block p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                    ...
                    <Link href="/client-manager/orders" className="block p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
