    ...
    <div className="min-h-screen">
      <div className="mx-auto lg:p-6 p-0">
        ...
        <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} className="mb-8">
          <button
            onClick={() => router.push("/client-manager/users")}
        ...
        >
          ...
          <div className="p-8">
            ...
            >
              ...
              <Link href={`${ApplicationRoutes.ClientManagerUsers}/${customer.id}/edit`} className="px-6 py-3 bg-gradient-to-r from-yellow-500 to-red-600 text-white rounded-xl font-semibold hover:from-red-600 hover:to-red-700 transform hover:scale-105 transition-all duration-200 shadow-lg hover:shadow-xl">
                Edit User
              </Link>
            </motion.div>
          </div>
