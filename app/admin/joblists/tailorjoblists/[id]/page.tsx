...
export default function ShowCustomer() {
  ...
  const handleUploadImage = async () => {
    ...
    // Change the key to "design_image"
    ...
    try {
      ...
      const result = await response.json();
      console.log(result);
      setImagePath(result.data.image_path); // Store the image path
    ...
    <div className="w-full mx-auto p-6 bg-white rounded-2xl shadow-md">
      ...
      <form>
        ...
        <div className="w-full">
          <div className="block text-xl font-bold text-gray-700 mt-10 mb-1">Measurements</div>
          <div className="mb-4">
            ...
            <div className="flex space-x-4 mb-4">
              <div className="w-1/3">
                <label htmlFor="shoulder_width" className ="block text-sm font-medium text-gray-700">Shoulder Width</label>
                <input
                  type="number"
                  readOnly
                  id="shoulder_width"
              ...
              <div className="w-1/3">
                <label htmlFor="arm_length" className="block text-sm font-medium text-gray-700">Arm Length</label>
                <input
                  type="number"
                  readOnly
                  id="arm_length"
            ...
            <div className="flex space-x-4 mb-4">
              <div className="w-1/3">
                <label htmlFor="back_length" className="block text-sm font-medium text-gray-700">Back Length</label>
                <input
                  type="number"
                  readOnly
                  id="back_length"
              ...
              <div className="w-1/3">
                <label htmlFor="front_length" className="block text-sm font-medium text-gray-700">Front Length</label>
                <input
                  type="number"
                  readOnly
                  id="front_length"
              ...
              <div className="w-1/3">
                <label htmlFor="highBust" className="block text-sm font-medium text-gray-700">High Bust</label>
                <input
                  type="number"
                  readOnly
                  id="highBust"
      ...
      <div className="text-gray-700">
        ...
        {imagePath && (
          <div className="mt-4 text-gray-700">
            <div>Image has been sent</div>
            <img src={imagePath} alt="Uploaded" className="mt-2 h-24 w-24 object-cover" />
 </div>
        )}
      </div>
    </div>
