...
export default function ProjectManagerDropdown() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch("/api/assignprojectmanager/", {
        method: "POST",
        headers: {
        ...
        <div className="w-full max-w-md mt-10">
          ...
          {loading ? (
            ...
            <div>
              ...
              <div className="mt-2 block w-full p-2 border border-gray-300 rounded-lg shadow-sm focus:ring focus:ring-green-300 focus:outline-none">
                {managers.map((manager) => (
