      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <div>
            <div className="flex justify-between flex-row">
                <div>Logo</div>
                <div className="text-right">Date: {customer.date}</div>
            </div>
            <div className="font-bold text-7xl">INVOICE</div>
            <div className="flex flex-row">
                <div className="flex flex-col w-1/2">
                    <div>
                        <div className="text-2xl my-2 font-bold">Billed To:</div>
