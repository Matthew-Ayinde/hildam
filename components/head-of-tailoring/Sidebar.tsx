      ...
      >
        <motion.div className="flex items-center" whileHover={{ scale: 1.02 }}>
          ...
          <div className="ml-3">
            ...
            <div className="text-orange-300 text-xs font-medium">Head Of Tailoring Panel</div>
          </div>
        </motion.div>
                  ...
                  <div className="max-h-80 overflow-y-auto">
                    ...
                    {notifications.length > 5 && (
                      <div className="p-3 border-t border-gray-100 bg-gray-50">
                        <Link href="/head-of-tailoring/notifications">
                          <motion.button
        ...
        >
          <div className="flex items-center">
            ...
            <div className="ml-3">
              ...
              <div className="text-orange-300 text-sm font-medium">Head Of Tailoring Panel</div>
            </div>
          </div>
        </motion.div>
        ...
        <div className="mb-6 px-6">
          ...
          >
            ...
            <Link
              ...
              onClick={closeSidebar}
            >
              <MdDashboard className={`text-lg ${pathname === "/head-of-tailoring" ? "text-orange-400" : ""}`} />
              <span>Dashboard</span>
            </Link>
          </motion.div>
        </div>
