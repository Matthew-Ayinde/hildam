  ...
  return (
    <Card className="card-floating sticky top-6">
      <CardContent className="p-6">
        ...
        {/* Back to Main Help */}
        <Link href="/client-manager/help" className="block mb-4">
          <motion.div
            whileHover={{ x: 4 }}
            className={`flex items-center gap-3 p-3 rounded-xl transition-all duration-200 ${
              pathname === "/client-manager/help"
        ...
        <div className="border-t border-gray-200 pt-4 mt-6">
          ...
          <div className="space-y-2">
            <Link href="/client-manager" className="block">
              <motion.div
                whileHover={{ x: 4 }}
            ...
            <Link href="/client-manager/customers" className="block">
              <motion.div
                whileHover={{ x: 4 }}
                className="flex items-center gap-3 p-2 rounded-lg hover:bg-gray-100 text-gray-700 transition-colors"
              >
            ...
            <Link href="/client-manager/orders" className="block">
              <motion.div
                whileHover={{ x: 4 }}
                className="flex items-center gap-3 p-2 rounded-lg hover:bg-gray-100 text-gray-700 transition-colors"
              >
