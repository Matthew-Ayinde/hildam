...
const Topbar = ({ onNotificationUpdate }: TopbarProps) => {
  ...
  return (
    <motion.div
      ...
      className="sticky md:block hidden top-0 z-[60] bg-white shadow-sm border-b border-gray-100 rounded-2xl mt-5"
    >
        ...
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center">
            <div>
              ...
              <p className="text-sm text-orange-600 font-medium">Client Manager</p>
            </div>
          </div>
                  ...
                  >
                    ...
                    <div className="max-h-[450px] overflow-y-auto">
                      ...
                      <div className="p-4 border-t border-gray-100 bg-gray-50">
                        <Link href="/client-manager/notifications" passHref>
                          <motion.button
